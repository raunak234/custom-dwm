...
static const char col_gray4[]       = "#C4C4C4";
static const char col_cyan[]        = "#6d4d94";
static const char col_bordernorm[]  = "#1e222a";
static const char col_bordersel[]   = "#C4C4C4";
...
static const char *screenshot[] = { "screenshot", NULL }; /*decrease brightness*/
